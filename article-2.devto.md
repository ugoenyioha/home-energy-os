---
title: "When the Gateway Goes Dark: A First Outage Postmortem"
published: false
description: A real power outage tested my home energy controller for the first time and found something the original design didn't account for — the resilience of the resilience system itself.
...
I noticed something was wrong because I couldn't reach the gateway by SSH. I ran a couple of probes from different paths — Tailscale, direct LAN, the public name — and all of them returned "network unreachable." That ruled out a routing problem. The gateway was — it turns out — plugged into the wrong outlet.

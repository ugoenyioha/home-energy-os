...
- `screenshots/system-architecture.png` — §5 (policy engine). Architectural flowchart showing Vendor Observers, Home Assistant State Fusion, Control Plane (Node-RED/Sentinel), and Hardware Actuators. Replaced the earlier `state-machine-policy-engine.png`.

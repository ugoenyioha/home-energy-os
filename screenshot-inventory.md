...
- `screenshots/sankey-day-live.png` — opening hero. Daytime Sankey showing 12 kW of solar production perfectly balanced across grid export, Franklin battery at cap, and home load during a sunny afternoon (May 11). Replaced the `evidence-dashboard.png`.

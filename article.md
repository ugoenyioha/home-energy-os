...
![Live Sankey from the deployed system: 4.5 kW of solar plus 4 kW of grid feeding an 8.6 kW home load, broken down all the way to individual circuits. The 1,638 W Lighting breaker splits into 579 W Cluster (the compute cluster's load isolated by EcoFlow pass-through subtraction), 432 W Office UPS, 338 W Hall/Pantry/Den lights, and so on — a per-circuit breakdown no single vendor can produce.](screenshots/sankey-day-real.png)
